...
export default function Marketplace() {
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://smartwaste-backend.onrender.com/api/user/profile/${clerkId}`
        );
  ...
  const handlePayment = async (listingId, finalPrice) => {
    ...
    try {
      const res = await fetch(
        `https://smartwaste-backend.onrender.com/api/payment/order`,
        {
          method: "POST",
          headers: {
  ...
  const handlePaymentVerify = async (data, listingId, finalPrice) => {
    const options = {
      ...
      handler: async (response) => {
        ...
        try {
          const res = await fetch(
            `https://smartwaste-backend.onrender.com/api/payment/verify`,
            {
              method: "POST",
              headers: {
                "content-type": "application/json",
  ...
  const fetchListings = async () => {
    try {
      ...
      const response = await axios.get(
        "https://smartwaste-backend.onrender.com/api/listings",
        { params }
      );
  ...
  const handleDiscountChange = (listingId, coins, maxCoins) => {
    ...
    if (safeCoins > userGreenCoins) {
      ...
      const validCoins = Math.min(
        userGreenCoins,
        discountCoins[listingId] || 0
      );
  ...
  //       `https://smartwaste-backend.onrender.com/api/listings/${listingId}`,
  ...
  const fetchPurchasedItems = async () => {
    try {
      ...
      const response = await axios.get(
        "https://smartwaste-backend.onrender.com/api/listings/purchased",
        {
  ...
  const handlePurchase = async (listingId, finalPrice) => {
    try {
      ...
      console.log(
        `Purchasing item ${listingId} for Rs. ${finalPrice} with ${coinsUsed} GreenCoins discount`
      );

      // Send request to purchase the item and deduct coins
      const response = await axios.post(
        "https://smartwaste-backend.onrender.com/api/listings/purchase",
        {
          listingId,
          price: coinsUsed,
        },
        ...
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center">
            ...
            <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300 text-lg">
              Connect with buyers and sellers of recyclable waste materials
              through our community marketplace, turning waste into valuable
              resources.
            </p>
          </div>
                ...
                {loading ? (
                  ...
                  listings
                    ...
                    .map((listing) => (
                      <div
                        key={listing._id}
                        className="bg-white dark:bg-neutral-700 p-4 rounded-lg mb-3 shadow-sm hover:shadow-md transition duration-300"
                      >
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      handleDiscountChange(
                                        ...
                                        Math.min(listing.price, userGreenCoins)
                                      )
                                    }
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">
                        Explore various ecofreindly recyclable products on
                        marketplace.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">
                        Use chatbot for more information and Contact us for any
                        queries.
                      </p>
                    </div>
                  </div>
              ...
              <div className="overflow-y-auto max-h-[750px] p-4">
                {purchasedListings.length === 0 ? (
                  ...
                  [...purchasedListings].reverse().map((listing) => (
                    <div
                      key={listing._id}
                      className="bg-white dark:bg-neutral-700 p-4 rounded-lg mb-3 shadow-sm"
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex flex-col text-sm text-gray-500 dark:text-gray-400">
                          ...
                          <span className="  font-medium">
                            ...
                            {listing.amount - listing.price} Rs
                          </span>
                        </div>
                      </div>
                    </div>
